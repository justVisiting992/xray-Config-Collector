...
### 🕒 Last Update
- **Tehran Time:** 🇮🇷 `1405/02/08` | `21:20:22`
- **International:** 🌐 `Tuesday, 28 Apr 2026`

### ⚡ Global Statistics
- **Total Configs Processed:** `894` (Total Unique)
- **Total Alive:** `885` 🚀
...
| :--- | :--- | :--- |
| 📢 [persianvpnhub](https://t.me/s/persianvpnhub) | `Hiddify/HA, MTProto, NPV/NPVT, SS, Trojan, VLess, VMess, WireGuard` | ✅ 30 Configs via API |
...
| 📢 [ghalagyann](https://t.me/s/ghalagyann) | `Hiddify/HA, NPV/NPVT, OpenVPN, SS, Trojan, VLess, VMess, WireGuard` | ✅ 1 found |
